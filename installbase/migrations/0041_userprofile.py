    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.CharField(choices=[('researcher', '연구원'), ('senior_researcher', '선임연구원'), ('chief_researcher', '책임연구원'), ('lead_researcher', '수석연구원'), ('team_leader', '팀장'), ('division_head', '사업부장')], default='researcher', max_length=20, verbose_name='직급')),
